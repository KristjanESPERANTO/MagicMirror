...
class NodeHelper {
	 ...
	 * Methods are assigned to the prototype so they are available during
	 * construction (e.g. when init() is called from the base constructor).
	...
	static create (moduleDefinition) {
		const SubClass = class extends NodeHelper {};
